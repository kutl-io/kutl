...
mod tests {
    ...
    async fn start_test_relay() -> (String, tempfile::NamedTempFile) {
        ...
        let (app, _handle, _flush_handle) = kutl_relay::build_app_with_backends(
            config,
            None,
            None,
            None,
            ...
            None,
            std::sync::Arc::new(kutl_relay::observer::TracingObserver),
            std::sync::Arc::new(kutl_relay::observer::NoopBeforeMergeObserver),
            None,
            std::sync::Arc::new(kutl_relay::mcp_tools::NoopToolProvider),
            std::sync::Arc::new(kutl_relay::mcp_tools::DefaultInstructionsProvider),
        )
        .unwrap();
