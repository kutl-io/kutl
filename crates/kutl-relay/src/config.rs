...
pub struct RelayConfig {
    ...
    /// an identity would also construct a `SegmentRecordLog`, flip
    /// `supports_signal_records` and un-gate re-seed — turning on client-supplied
    /// history as a side effect of provisioning a key.
    ///
