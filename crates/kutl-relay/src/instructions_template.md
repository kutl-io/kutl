...
- **Documents.** Markdown content addressed by UUID or path.
  ...
  - `edit_document` to update existing content — supply the full
    desired markdown; the relay computes the minimal CRDT diff.
    Provide a short `intent` string describing your edit.
