...
/// Set parallel to [`crate::MAX_OPS_PER_DOC`]; since a change spans one or
/// more ops, this is a generous bound that steady-state usage never reaches.
pub const MAX_CHANGES_PER_DOC: usize = crate::MAX_OPS_PER_DOC;
