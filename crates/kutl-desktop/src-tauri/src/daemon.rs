...
pub(crate) fn build_worker_config(
    ...
    let worker_config = kutl_daemon::SpaceWorkerConfig {
        ...
        // The real platform watcher; poll mode is a test-suite knob.
        poll_watcher: false,
    };
...
impl DaemonSupervisor {
    ...
    /// `.kutl/space.json` changed between attempts picks up the new values.
...
mod tests {
    ...
    /// Write a minimal on-disk space (`.kutl/space.json`) under `dir` and
